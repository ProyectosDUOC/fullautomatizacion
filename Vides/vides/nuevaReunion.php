    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Nueva Entrada Reunión</li>
        </ol>
      </section>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Reunión</h3>
            </div>
            <form role="form" method="POST" action="../../Controlador/cNuevaReunion.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" min="1" max="24" class="form-control" id="descripcion" placeholder="Hora 1-24" name="txtHora" required="">
                  <input type="number" min="0" max="59" class="form-control"  placeholder="Min 0-59" name="txtMinuto" required="">
